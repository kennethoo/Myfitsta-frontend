...
class VideoPro extends Component {
  state = {
    playing: false,
    x: null,
  };
  ...
  play = (event) => {
    ...
    let video = document.querySelector(".videe");
  ...
  getTimeur = () => {
    let video = document.querySelector(".videe");
    let end = document.querySelector(".end-entimeurr");
    ...
    return (
      <div className="wraproor">
        <div className="wrpaer-video">
          <video onLoadedMetadata={this.getTimeur} className="videe">
            ...
            <div className="wraper-div-actionr-omne">
              ...
              <div className="timeur-intheplayyer">
                <div className="box-hold-thsttimeur">
                  ...
                  <p className="end-entimeurr">0:00</p>
                </div>
              </div>
            </div>
            <div className="wraper-div-actionr-two">
